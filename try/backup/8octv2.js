// this is very well working file
(async function(page) {
    ...
    // Function to check if the current URL contains any of the excluded substrings
    function isExcludedUrl() {
        const currentUrl = window.location.href;
        return excludedSubstrings.some(substring => currentUrl.includes(substring));
    }

    // Return early if the current URL matches the excluded patterns
    if (isExcludedUrl()) {
        console.log("Excluded URL detected. Stopping execution of fetch.js.");
